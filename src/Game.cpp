	  ...
	  if (event.type == sf::Event::MouseButtonPressed)
	    {
		  ...
		  && getButton (Button::STR).Y + getButton (Button::STR).H >
		  y)
		{
		  buttonSound.play ();
		  music.stop ();
		  ...
		  && getButton (Button::INF).Y + getButton (Button::INF).H >
		  y)
		{
		  buttonSound.play ();
		  while (1)
			  ...
			  if (event.type == sf::Event::MouseButtonPressed)
			    {
				  ...
				  && getButton (Button::BC).X +
				  getButton (Button::BC).W > x
				  && getButton (Button::BC).Y < y
				  && getButton (Button::BC).Y +
				  getButton (Button::BC).H > y)
				{
				  buttonSound.play ();
				  music.stop ();
				  menu ();
		  ...
		  && getButton (Button::EX).Y + getButton (Button::EX).H > y)
		{
		  ...
		  && getButton (Button::SP1).Y + getButton (Button::SP1).H >
		  y)
		{
		  buttonSound.play ();
		  speedLife = 1;
		  ...
		  && getButton (Button::SP2).Y + getButton (Button::SP2).H >
		  y)
		{
		  buttonSound.play ();
		  speedLife = 10;
...
void
Game::showCondition (std::string condition_)
{
  if (condition_ == "ill")
    Game::ill ();
  if (condition_ == "happy")
...
void
Game::showThoughts (std::string thoughts)
{
  if (thoughts == "need_wc")
    Game::needWc ();
  if (thoughts == "hungry")
